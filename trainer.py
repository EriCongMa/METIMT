...
from task.train_modal_contrastive_learning_timt import modal_contrastive_learning_timt_train
...
if __name__ == '__main__':
    ...
    # parser.add_argument('--CL_Task', type=str, default='no', help='whether using contrastive learning or not. yes or no.')
    parser.add_argument('--CL_Task', action="store_true")
    ...
    if opt.task == "modal_contrastive_learning_timt":
        modal_contrastive_learning_timt_train(opt)
    else:
