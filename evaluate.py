...
def modal_contrastive_learning_timt_task_eval(opt):
    ...
    with torch.no_grad():
        ...
        for image_tensors, image_path_list in demo_loader:
            ...
            # opt.batch_max_length = opt.tgt_batch_max_length
            ...
            valid_src_mask = make_std_mask(src_text_for_pred[:, :], pad = 2)[0]
...
if __name__ == '__main__':
    ...
    if opt.task == 'modal_contrastive_learning_timt':
        modal_contrastive_learning_timt_task_eval(opt)
